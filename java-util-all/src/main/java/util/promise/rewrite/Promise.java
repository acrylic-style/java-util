...
public class Promise<T> {
     ...
     */
    @Contract("_ -> new")
    public static <T> @NotNull Promise<T> sleepPromise(long millis) {
     ...
     */
    @Contract("_ -> new")
    public static <T> @NotNull ThrowableFunction<T, T> sleep(long millis) {
        return t -> {
            Thread.sleep(millis);
            return t;
        };
    ...
    @Contract("_ -> new")
    public static <T1> @NotNull L1<T1> all(
    ...
    @Contract("_, _ -> new")
    public static <T1, T2> @NotNull L2<T1, T2> all(
    ...
    @SuppressWarnings("unchecked")
    @Contract("_, _, _ -> new")
    public static <T1, T2, T3> @NotNull L3<T1, T2, T3> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
    ...
    public static <T1, T2, T3, T4> @NotNull L4<T1, T2, T3, T4> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
            @NotNull Promise<T3> t3,
    ...
    public static <T1, T2, T3, T4, T5> @NotNull L5<T1, T2, T3, T4, T5> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
            @NotNull Promise<T3> t3,
            @NotNull Promise<T4> t4,
    ...
    public static <T1, T2, T3, T4, T5, T6> @NotNull L6<T1, T2, T3, T4, T5, T6> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
            @NotNull Promise<T3> t3,
            @NotNull Promise<T4> t4,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7> @NotNull L7<T1, T2, T3, T4, T5, T6, T7> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
            @NotNull Promise<T3> t3,
            @NotNull Promise<T4> t4,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8> @NotNull L8<T1, T2, T3, T4, T5, T6, T7, T8> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
            @NotNull Promise<T3> t3,
            @NotNull Promise<T4> t4,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9> @NotNull L9<T1, T2, T3, T4, T5, T6, T7, T8, T9> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
            @NotNull Promise<T3> t3,
            @NotNull Promise<T4> t4,
    ...
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> @NotNull L10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> all(
            @NotNull Promise<T1> t1,
            @NotNull Promise<T2> t2,
            @NotNull Promise<T3> t3,
            @NotNull Promise<T4> t4,
    ...
    @NotNull
    @SafeVarargs
    public static <T> ICollectionList<T> allLazyTyped(@NotNull Promise<T>@NotNull... promises) {
        return ICollectionList.asList(promises).parallelStream().map(Promise::complete).collect(ICollectionList.toCollectionList());
    }

    @NotNull
    public static ICollectionList<?> allUntyped(@NotNull Promise<?>@NotNull... promises) {
        return ICollectionList.asList(promises).parallelStream().map(Promise::complete).collect(ICollectionList.toCollectionList());
    }
    //</editor-fold>
    ...
    private <R> @NotNull Promise<R> setupExecutor(@NotNull Promise<R> promise) {
