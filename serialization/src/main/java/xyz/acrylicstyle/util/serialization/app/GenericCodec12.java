...
import xyz.acrylicstyle.util.serialization.constructors.CodecConstructor12;
...
final class GenericCodec12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, T> extends Codec<T> {
    ...
    private final CodecConstructor12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, T> constructor;

    public GenericCodec12(
            MapCodec<P1, T> p1,
            MapCodec<P2, T> p2,
            MapCodec<P3, T> p3,
            MapCodec<P4, T> p4,
            ...
            MapCodec<P11, T> p11,
            MapCodec<P12, T> p12,
            CodecConstructor12<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, T> constructor
    ) {
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
    ...
    public T decode(@NotNull ValueDecoder decoder) {
        ...
        return constructor.create(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
    }
