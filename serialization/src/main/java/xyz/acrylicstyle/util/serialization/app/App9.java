...
public final class App9<A, P1, P2, P3, P4, P5, P6, P7, P8, P9> {
    ...
    public @NotNull Codec<A> build(@NotNull CodecConstructor9<P1, P2, P3, P4, P5, P6, P7, P8, P9, A> constructor) {
        return new GenericCodec9<>(p1, p2, p3, p4, p5, p6, p7, p8, p9, constructor);
    }
}
