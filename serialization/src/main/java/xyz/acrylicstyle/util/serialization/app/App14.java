...
public final class App14<A, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14> {
    ...
    public @NotNull Codec<A> build(@NotNull CodecConstructor14<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, A> constructor) {
        return new GenericCodec14<>(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, constructor);
    }
}
