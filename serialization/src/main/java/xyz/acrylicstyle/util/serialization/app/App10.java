...
public final class App10<A, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10> {
    ...
    public @NotNull Codec<A> build(@NotNull CodecConstructor10<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, A> constructor) {
        return new GenericCodec10<>(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, constructor);
    }
}
