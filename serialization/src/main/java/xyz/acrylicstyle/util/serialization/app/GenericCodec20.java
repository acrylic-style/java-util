...
final class GenericCodec20<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, T> extends Codec<T> {
    ...
    public T decode(@NotNull ValueDecoder decoder) {
        ...
        P17 p17 = decoder.pushPop(this.p17::decodeValue).getValue();
        P18 p18 = decoder.pushPop(this.p18::decodeValue).getValue();
        P19 p19 = decoder.pushPop(this.p19::decodeValue).getValue();
        P20 p20 = decoder.pushPop(this.p20::decodeValue).getValue();
