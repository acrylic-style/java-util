...
import xyz.acrylicstyle.util.serialization.constructors.CodecConstructor20;
...
final class GenericCodec20<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, T> extends Codec<T> {
    ...
    private final MapCodec<P17, T> p17;
    private final MapCodec<P18, T> p18;
    private final MapCodec<P19, T> p19;
    private final MapCodec<P20, T> p20;
    private final CodecConstructor20<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, T> constructor;

    public GenericCodec20(
            MapCodec<P1, T> p1,
            MapCodec<P2, T> p2,
            MapCodec<P3, T> p3,
            MapCodec<P4, T> p4,
            ...
            MapCodec<P19, T> p19,
            MapCodec<P20, T> p20,
            CodecConstructor20<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, T> constructor
    ) {
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
    ...
    public T decode(@NotNull ValueDecoder decoder) {
        ...
        P15 p15 = decoder.pushPop(this.p15.getName(), this.p15::decodeValue);
        P16 p16 = decoder.pushPop(this.p16.getName(), this.p16::decodeValue);
        P17 p17 = decoder.pushPop(this.p17.getName(), this.p17::decodeValue);
        P18 p18 = decoder.pushPop(this.p18.getName(), this.p18::decodeValue);
        P19 p19 = decoder.pushPop(this.p19.getName(), this.p19::decodeValue);
        P20 p20 = decoder.pushPop(this.p20.getName(), this.p20::decodeValue);
        return constructor.create(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20);
    }
    ...
    public void encode(@NotNull T value, @NotNull ValueEncoder encoder) {
        ...
        encoder.pushPop(p17.getName(), () -> p17.encode(value, encoder));
        encoder.pushPop(p18.getName(), () -> p18.encode(value, encoder));
        encoder.pushPop(p19.getName(), () -> p19.encode(value, encoder));
        encoder.pushPop(p20.getName(), () -> p20.encode(value, encoder));
    }
}
