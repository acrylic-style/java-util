...
final class GenericCodec11<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, T> extends Codec<T> {
    ...
    private final CodecConstructor11<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, T> constructor;

    public GenericCodec11(
            MapCodec<P1, T> p1,
            MapCodec<P2, T> p2,
            MapCodec<P3, T> p3,
            MapCodec<P4, T> p4,
            ...
            MapCodec<P10, T> p10,
            MapCodec<P11, T> p11,
            CodecConstructor11<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, T> constructor
    ) {
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
    ...
    public T decode(@NotNull ValueDecoder decoder) {
        ...
        return constructor.create(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11);
    }
