...
import xyz.acrylicstyle.util.serialization.constructors.CodecConstructor9;
...
final class GenericCodec9<P1, P2, P3, P4, P5, P6, P7, P8, P9, T> extends Codec<T> {
    ...
    private final CodecConstructor9<P1, P2, P3, P4, P5, P6, P7, P8, P9, T> constructor;

    public GenericCodec9(
            MapCodec<P1, T> p1,
            MapCodec<P2, T> p2,
            MapCodec<P3, T> p3,
            MapCodec<P4, T> p4,
            ...
            MapCodec<P8, T> p8,
            MapCodec<P9, T> p9,
            CodecConstructor9<P1, P2, P3, P4, P5, P6, P7, P8, P9, T> constructor
    ) {
        this.p1 = p1;
        this.p2 = p2;
        this.p3 = p3;
