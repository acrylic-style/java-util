...
public interface GeneratorFunction<T> extends Iterator<GeneratorFunctionResult<T>> {
    ...
    default void yield(T value) {
        ...
        //}
        GeneratorResultHolder.holder.put(this, new GeneratorFunctionResult<>(value, false));
    ...
    default GeneratorFunction<T> start() {
        Thread thread = new Thread(() -> GeneratorResultHolder.holder.put(this, new GeneratorFunctionResult<>(apply(this), true)));
        thread.start();
        GeneratorLockHolder.holder.put(this, thread);
        return this;
    }
