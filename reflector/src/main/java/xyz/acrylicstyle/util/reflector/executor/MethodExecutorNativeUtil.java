...
public class MethodExecutorNativeUtil implements MethodExecutor {
    ...
    @Override
    public Object invoke(@NotNull Method method, Object instance, Object @NotNull ... args) {
        return NativeUtil.invoke(method, instance, args);
    }

    @Override
    public Object invokeSpecial(@NotNull Method method, @NotNull Object instance, Object... args) {
        return NativeUtil.invokeNonvirtual(method, instance, args);
    }

    @Override
    public <T> @NotNull T newInstance(@NotNull Constructor<T> constructor, Object... args) {
        return NativeUtil.newInstance(constructor, args);
    }
