...
@SuppressWarnings({"unused", "ManualMinMaxCalculation", "UnusedAssignment"})
public final class MathUtils {
    ...
    public static long multiplyExact(long x, long y) {
        long r = x * y;
        long ax = MathUtils.abs(x);
        long ay = MathUtils.abs(y);
        if (((ax | ay) >>> 31 != 0)) {
     ...
     * where <i>e</i> is {@linkplain MathUtils#E Euler's number}.
     *
     * <p>Special cases:
     * <ul>
     *
     ...
     * in other words, {@linkplain MathUtils#sinh
     * sinh(<i>x</i>)}/{@linkplain MathUtils#cosh cosh(<i>x</i>)}.  Note
    ...
    public static double scalb(double d, int scaleFactor) {
        ...
        if(scaleFactor < 0) {
            scaleFactor = MathUtils.max(scaleFactor, -MAX_SCALE);
            scale_increment = -512;
            exp_delta = twoToTheDoubleScaleDown;
        }
        else {
            scaleFactor = MathUtils.min(scaleFactor, MAX_SCALE);
            scale_increment = 512;
    ...
    public static float scalb(float f, int scaleFactor) {
        ...
        // Make sure scaling factor is in a reasonable range
        scaleFactor = MathUtils.max(MathUtils.min(scaleFactor, MAX_SCALE), -MAX_SCALE);
